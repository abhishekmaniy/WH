                        ...
                        selectBtn ? (
                            <>
                                <Heading fontWeight={600} fontSize={{ base: '3xl', sm: '4xl', md: '6xl' }} lineHeight={'110%'}>
                                    ...
                                    <Text as={'span'} color={'#38B2AC'}>easy </Text> steps
                                </Heading>
                                ...
                                <Flex textAlign={'start'} flexDirection={'column'} w={'full'}>
                                    {['Select a template from our collection.', 'Build your resume using our easy to use resume builder.', 'Download your resume.'].map((text, index) => (
                                        <Box className='Bullet_Points' key={index}>
                                            <Button>{index + 1}</Button>
                                            <Text color={'gray.900'} fontSize={'xl'}>{text}</Text>
                                        </Box>
                                    ))}
                                </Flex>
                            </>
                            ...
                            <Heading m={'1.5'} textAlign={{ base: 'center', md: 'start' }} fontWeight={600} fontSize={{ base: '3xl', sm: '4xl', md: '6xl' }} lineHeight={'110%'}>
                                Select a {' '}
                                <Text as={'span'} color={'#38B2AC'}>Template </Text>
                                from the list
                            </Heading>
                        )
                    }
